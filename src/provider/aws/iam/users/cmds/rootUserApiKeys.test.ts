...
import { handler } from './rootUserApiKeys'
import papa from 'papaparse'

const csv_fail_1 = `user,arn,user_creation_time,password_enabled,password_last_used,password_last_changed,password_next_rotation,mfa_active,access_key_1_active,access_key_1_last_rotated,access_key_1_last_used_date,access_key_1_last_used_region,access_key_1_last_used_service,access_key_2_active,access_key_2_last_rotated,access_key_2_last_used_date,access_key_2_last_used_region,access_key_2_last_used_service,cert_1_active,cert_1_last_rotated,cert_2_active,cert_2_last_rotated
<root_account>,arn:aws:iam::test:root,2018-03-07T21:35:12+00:00,not_supported,2020-10-15T01:16:31+00:00,not_supported,not_supported,false,true,N/A,N/A,N/A,N/A,false,N/A,N/A,N/A,N/A,false,N/A,false,N/A
...
const csv_fail_2 = `user,arn,user_creation_time,password_enabled,password_last_used,password_last_changed,password_next_rotation,mfa_active,access_key_1_active,access_key_1_last_rotated,access_key_1_last_used_date,access_key_1_last_used_region,access_key_1_last_used_service,access_key_2_active,access_key_2_last_rotated,access_key_2_last_used_date,access_key_2_last_used_region,access_key_2_last_used_service,cert_1_active,cert_1_last_rotated,cert_2_active,cert_2_last_rotated
<root_account>,arn:aws:iam::test:root,2018-03-07T21:35:12+00:00,not_supported,2020-10-15T01:16:31+00:00,not_supported,not_supported,false,false,N/A,N/A,N/A,N/A,true,N/A,N/A,N/A,N/A,false,N/A,false,N/A
customer1,arn:aws:iam::test:user/customer1,2019-12-28T20:00:51+00:00,false,N/A,N/A,N/A,false,true,2019-12-28T20:00:51+00:00,2020-11-21T20:38:00+00:00,us-east-1,iam,true,2020-09-25T03:06:58+00:00,N/A,N/A,N/A,false,N/A,false,N/A`

const csv_fail_3 = `user,arn,user_creation_time,password_enabled,password_last_used,password_last_changed,password_next_rotation,mfa_active,access_key_1_active,access_key_1_last_rotated,access_key_1_last_used_date,access_key_1_last_used_region,access_key_1_last_used_service,access_key_2_active,access_key_2_last_rotated,access_key_2_last_used_date,access_key_2_last_used_region,access_key_2_last_used_service,cert_1_active,cert_1_last_rotated,cert_2_active,cert_2_last_rotated
<root_account>,arn:aws:iam::test:root,2018-03-07T21:35:12+00:00,not_supported,2020-10-15T01:16:31+00:00,not_supported,not_supported,false,true,N/A,N/A,N/A,N/A,true,N/A,N/A,N/A,N/A,false,N/A,false,N/A
customer1,arn:aws:iam::test:user/customer1,2019-12-28T20:00:51+00:00,false,N/A,N/A,N/A,false,true,2019-12-28T20:00:51+00:00,2020-11-21T20:38:00+00:00,us-east-1,iam,true,2020-09-25T03:06:58+00:00,N/A,N/A,N/A,false,N/A,false,N/A`
...
describe('RootUserApiKey', () => {
  ...
  it('should report UNKNOWN if an unexpected getReport call is returned', async () => {
  ...
  it('should attempt to get the generate the credential report if it is not found', async () => {
    ...
    await handler({ region: 'all', sleep: 0, rule: 'ApiKeys' })

    expect(getCredentialReportStub.callCount).to.eql(2)
    expect(generateCredentialReportStub.callCount).to.eql(1)
  })

  it('should report FAIL if the root users first api key is active', async () => {
    mock('IAM', 'getCredentialReport', {
      GeneratedTime: new Date(0).toISOString(),
      Content: csv_fail_1,
    })
  ...
  it('should report FAIL if the root users second api key is active', async () => {
    mock('IAM', 'getCredentialReport', {
      GeneratedTime: new Date(0).toISOString(),
      Content: csv_fail_2,
    })
  ...
  it('should report FAIL if both the root users keys are active', async () => {
    mock('IAM', 'getCredentialReport', {
      GeneratedTime: new Date(0).toISOString(),
      Content: csv_fail_3,
    })
    ...
    expect(audits).to.eql([
      {
        comment: 'access_key_1_active,access_key_2_active',
        provider: 'aws',
        physicalId: 'root-user',
        service: 'iam',
        rule: 'ApiKeys',
  ...
  it('should report OK if both the root users keys are inactive', async () => {
    mock('IAM', 'getCredentialReport', {
      GeneratedTime: new Date(0).toISOString(),
      Content: csv_pass,
    })
